...
x = input()
if x == 'расслабиться':
    print('Ты проволился в какую-то комнату, а ещё, у тебя галюны.')
else:
    if x == 'использовать_палочку' or 'попробоват выбраться':
        ...
        exit()
#bytilek
print("Твои галюны прошли, и ты увидел что ты в комнате без дверей и окон, осмотревшись ты увидел по середине комнаты столик с тремя бутыльками, потом ты увидел проход, но через него не пройти, он был весь в огне, ты сразу понял что в одном из бутыльков зелье огнестойкости, ты решил выпить какой-то из бутыльков.")
...
print('Используй заклинания, которые ты изучил на уроках Защиты от тёмных искусств')
print('...')
print('...')
print('...')
print('...')
...
waiting = input()
zaclenanie = input()
if waiting == 'Протего' and zaclenanie == 'Экспеллиармус' or zaclenanie == 'Авада кедавра' or zaclenanie == 'Эверте Статум':
